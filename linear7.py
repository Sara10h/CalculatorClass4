...
st.title("Image Processing Tools (Multi Filter Version)")
...
col1.image(img_arr, caption="Original Image", use_container_width=True)
col2.image(st.session_state.result, caption="Result", use_container_width=True)
